...
const Navbar = () => {
    ...
    const isHome = location.pathname === "/Home"; // Check if current page is Home
    ...
    const links = <>
        <NavLink 
            ...
            className={({ isActive }) =>
                isActive
                    ? "border-b-2 border-white pb-1" // underline white on purple
            ...
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul
                        ...
                        style={isHome ? { backgroundColor: "#9538E2", color: "white" } : { backgroundColor: "red", color: "black" }}
                    >
                        {links}
                    </ul>
                </div>
